...
// antes del render van las funciones
{
  ...
  insertarProfesor = () =>
  {
    ...
    fetch ('http://192.168.1.5/APImatriculasGrupoSabado/modelo/insertarProfesor.php',
    {
      method:'POST',
      headers:{
  ...
  fetch ('http://192.168.1.5/APImatriculasGrupoSabado/modelo/actualizarProfesor.php',
    {
      method: 'PUT',
      headers:
      {
  ...
  borrarProfesors = () =>
  {
    fetch ('http://192.168.1.5/APImatriculasGrupoSabado/modelo/borrarProfesor.php',
    {
      method: 'DELETE',
      headers:
      {
  ...
  listarProfesor = () =>
  {
    fetch ('http://192.168.1.5/APImatriculasGrupoSabado/modelo/listarProfesor.php',
    {
      method: 'GET',
      headers:
      {
